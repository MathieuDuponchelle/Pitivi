...
class PitiviViewer(Gtk.VBox, Loggable):
    ...
    def _createUi(self):
        ...
        self.internal = ViewerWidget(self.app)
        ...
        self.external = ViewerWidget(self.app)
...
class ViewerWidget(GtkClutter.Embed, Loggable):
    ...
    def __init__(self, app=None):
        ...
        # This is a trick to make the viewer appear black from the get go.
        # 42 means whatever in case you didn't get the memo ;)
        self.texture.set_from_rgb_data([0, 0, 0], False, 1, 1, 42, 3, Clutter.TextureFlags.NONE)
